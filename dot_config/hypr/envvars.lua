...
-- Only if you specifically want Proton's Wayland driver
hl.env("PROTON_ENABLE_WAYLAND", "0")

-- Only needed for games where you actually use OptiScaler
hl.env("PROTON_USE_OPTISCALER", "1")
hl.env("PROTON_FSR4_UPGRADE", "1")
hl.env("PROTON_FSR4_RDNA3_UPGRADE", "1")
hl.env("PROTON_XESS_UPGRADE", "1")

-- Not really needed on modern stacks
